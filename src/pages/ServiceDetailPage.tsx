...
export default function ServiceDetailPage() {
  ...
  const serviceData: Record<string, ServiceData> = {
    'business-logic-map': {
      ...
      subtitle: "Visualize and understand your application's complete logic flow to identify security vulnerabilities.",
      ...
      features: [
        {
          ...
          description: 'Interactive diagrams showing complete application logic with security annotations.',
          icon: <Network className="w-8 h-8" />
        },
        {
          title: 'Logic Flaw Detection',
          description: 'Advanced analysis to identify inconsistencies and security gaps in business rules.',
          icon: <Search className="w-8 h-8" />
        },
        {
          title: 'Access Control Verification',
          description: 'Thorough examination of authorization mechanisms across all application paths.',
          icon: <ShieldCheck className="w-8 h-8" />
        },
        {
          title: 'Integration Security Analysis',
          description: 'Security assessment of all external system integrations and data exchange points.',
          icon: <Zap className="w-8 h-8" />
        }
      ]
    },
    'cve-cwe-analysis': {
      title: 'CVE & CWE Analysis',
      subtitle: 'Comprehensive analysis of vulnerabilities and exposures to protect against known threats.',
      ...
      features: [
        {
          ...
          description: 'Automatic detection of vulnerable third-party components and libraries.',
          icon: <Search className="w-8 h-8" />
        },
        {
          title: 'Vulnerability Prioritization',
          description: 'Risk-based prioritization of findings based on exploitability and impact.',
          icon: <BarChart className="w-8 h-8" />
        },
        {
          title: 'Custom Remediation Guidance',
          description: 'Specific, actionable steps to address each vulnerability in your environment.',
          icon: <ShieldCheck className="w-8 h-8" />
        },
        {
          title: 'Continuous Monitoring',
          description: 'Real-time alerts for new vulnerabilities affecting your technology stack.',
          icon: <Zap className="w-8 h-8" />
        }
      ]
    },
    'threat-modeling': {
      ...
      subtitle: 'Proactive identification of potential security threats through advanced modeling techniques.',
      ...
      features: [
        {
          ...
          description: 'Systematic analysis covering spoofing, tampering, repudiation, information disclosure, denial of service, and elevation of privilege.',
          icon: <ShieldCheck className="w-8 h-8" />
        },
        {
          title: 'Attack Tree Analysis',
          description: 'Visual modeling of attack paths to identify complex multi-step attack scenarios.',
          icon: <Network className="w-8 h-8" />
        },
        {
          title: 'Risk Assessment Matrix',
          description: 'Quantified risk scoring to prioritize mitigation efforts based on impact and likelihood.',
          icon: <BarChart className="w-8 h-8" />
        },
        {
          title: 'Mitigation Strategy Development',
          description: 'Concrete security controls and architecture recommendations to address identified threats.',
          icon: <Zap className="w-8 h-8" />
        }
      ]
    },
    'endpoint-analysis': {
      ...
      subtitle: 'Secure your API endpoints with comprehensive vulnerability assessment and remediation.',
      ...
      features: [
        {
          ...
          description: 'Comprehensive testing of all endpoints for common vulnerabilities and implementation flaws.',
          icon: <Search className="w-8 h-8" />
        },
        {
          title: 'Authentication Analysis',
          description: 'Thorough assessment of identity verification mechanisms and session management.',
          icon: <ShieldCheck className="w-8 h-8" />
        },
        {
          title: 'Access Control Verification',
          description: 'Testing of authorization models to ensure proper resource protection.',
          icon: <Network className="w-8 h-8" />
        },
        {
          title: 'Data Validation Assessment',
          description: 'Analysis of input validation controls to prevent injection attacks and data corruption.',
          icon: <Zap className="w-8 h-8" />
        }
      ]
    },
    'security-scanning': {
      ...
      subtitle: 'Automated security scanning to detect and prioritize vulnerabilities in your codebase.',
      ...
      features: [
        {
          ...
          description: 'Code analysis to find security flaws without execution, including injection, XSS, and authorization issues.',
          icon: <Search className="w-8 h-8" />
        },
        {
          title: 'Dependency Vulnerability Scanning',
          description: 'Comprehensive analysis of third-party components to identify known security issues.',
          icon: <Network className="w-8 h-8" />
        },
        {
          title: 'Configuration Analysis',
          description: 'Review of application and infrastructure configurations for security weaknesses.',
          icon: <ShieldCheck className="w-8 h-8" />
        },
        {
          title: 'Compliance Verification',
          description: 'Automated checks against security standards like OWASP Top 10, PCI DSS, and HIPAA.',
          icon: <BarChart className="w-8 h-8" />
        }
      ]
    }
                    ...
                    {[
                      {
                        ...
                        description: 'We analyze your application architecture, technology stack, and security requirements to tailor our approach.'
                      },
                      {
                        title: 'Comprehensive Analysis',
                        description: 'Our experts conduct thorough security analysis using specialized tools and methodologies.'
                      },
                      {
                        title: 'Detailed Reporting',
                        description: 'You receive a comprehensive report with findings, risk assessments, and visualizations.'
                      },
                      {
                        title: 'Remediation Guidance',
                        description: 'We provide actionable recommendations and support for addressing identified security issues.'
                      }
                    ].map((step, index) => (
                      <motion.div
                        key={index}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <motion.h2
              ...
              transition={{ duration: 0.5 }}
            >
              Ready to strengthen your <span className="gradient-text">application security</span>?
            </motion.h2>
            <motion.p
            ...
            >
              Our team of security experts is here to help you protect your applications from threats.
            </motion.p>
            <motion.div
